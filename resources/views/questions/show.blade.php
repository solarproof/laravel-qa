                        ...
                        <div class="media">
                            <div class="d-flex flex-column vote-controls">
                                ...
                                <a title="Click to mark as favourite question (Click again to undo)"
                                   class="mt-2 {{ Auth::guest() ? 'off' : ($question->is_favourited ? 'favourited' : '') }} favourite"

                                   onclick="event.preventDefault(); document.getElementById('favourite-question-{{$question->id}}').submit();">

                                    <i class="fas fa-star fa-2x"></i> <span class="favourites-count">{{ $question->favourites_count }}</span></a>
